    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-9 col-lg-6">
            <div style="text-align: center;">
                <img style="margin: 0px auto 30px;" src="{{ @asset('/img/pdf/budora-image.png') }}" alt="Logo">
            </div>
            ...
            <div class="nav-tabs-custom">
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    ...
                    @else
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.password.email') }}" novalidate>
                        {!! csrf_field() !!}
