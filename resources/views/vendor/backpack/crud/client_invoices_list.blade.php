...
<div class="container-fluid">
  ...
  <div><strong>@lang('Balance'): {{ abs($balance) }} Eur {{ ($balance < 0) ? '(' . __('surplus') . ')' : '' }}</strong></div>
</div>
@endsection
