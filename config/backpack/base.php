...
return [
    ...
    */
    ...
    'project_name' => ' Sporto klubas "Budora"',
    ...
    'styles' => [
        ...
        'packages/main/style.css',
        'packages/laravel/style.css',
    ...
    'project_logo' => '<img style="width: 48px; position: absolute; left: 20px;" src="/img/pdf/budora-image.png" alt="Logo">',
    ...
    */
    ...
    'authentication_column_name' => 'El. paštas',
